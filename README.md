...
- [Simulation, Development and Testing](#simulation-development-and-testing)
...
| [openhop_repeater](https://github.com/openhop-dev/openhop_repeater) ![GitHub Repo stars](https://img.shields.io/github/stars/openhop-dev/openhop_repeater?style=social) | Lightweight Repeater Daemon in Python, built on the openhop_core MeshCore library (SPI LoRa radio support) | ![GitHub last commit](https://img.shields.io/github/last-commit/openhop-dev/openhop_repeater) |
...
| [MCO Advanced](https://github.com/HDDen/meshcore-open/releases) | Mod of Meshcore Open with one-packet lossless images sending over LoRa (called MCOimg), built-in wardrive, text compression and more features. Pre-built for iOS, Android, Linux, Windows | ![GitHub last commit](https://img.shields.io/github/last-commit/HDDen/meshcore-open) |
...
| [MeshCore Signal Tester](https://github.com/kybl/meshcore-signal-tester) ![GitHub Repo stars](https://img.shields.io/github/stars/kybl/meshcore-signal-tester?style=social) | Real-time signal tester for companions and repeaters, with per-repeater SNR/RSSI charts, a 3D signal map, and full packet details. [Web](https://meshcore.kyblsoft.cz/signal-tester) + Android app | ![GitHub last commit](https://img.shields.io/github/last-commit/kybl/meshcore-signal-tester) |
| [MeshCore TEAM](https://github.com/tmacinc/MeshCore-TEAM) ![GitHub Repo stars](https://img.shields.io/github/stars/tmacinc/MeshCore-TEAM?style=social) | **Additional TEAM features.** Cross-platform MeshCore TEAM companion app for Android/iOS. The App add team-oriented features and works with stock MeshCore firmware for location tracking, basic messaging, contacts, channels, and maps. Custom MeshCore TEAM firmware is required for full functionality, including tracker autonomous mode and smart forwarding. | ![GitHub last commit](https://img.shields.io/github/last-commit/tmacinc/MeshCore-TEAM) |
...
| [MeshCore TEAM enhanced firmware](https://github.com/tmacinc/MeshCore) ![GitHub Repo stars](https://img.shields.io/github/stars/tmacinc/MeshCore?style=social) | **Autonomous tracker custom firmware.** a custom firmware build layered on top of stock MeshCore. It adds team-oriented features for GPS tracking, smart forwarding control, and unattended autonomous operation. | ![GitHub last commit](https://img.shields.io/github/last-commit/tmacinc/MeshCore) |
| [MeshCore Filter Firmware](https://github.com/jhuebert/MeshCore) ![GitHub Repo stars](https://img.shields.io/github/stars/jhuebert/MeshCore?style=social) | **All MeshCore repeater targets** (Heltec V3, V4, CT-62, Wireless Tracker; Station G2/G3; RAK4631, RAK3401; SenseCap Solar; XIAO ESP32-S3 Wio SX1262; XIAO nRF52; T1000-E; Generic E22 SX1262). Remotely configurable packet filter for the MeshCore repeater: drop/forward rules on channel, sender, text, packet type, hops, region and signal strength, managed over the repeater CLI (serial or authenticated remote admin over the mesh) with no rebuild or physical access. Adds per-rule throttling, advert rate limiting, saved-airtime telemetry, and a battery voltage gate. Prebuilt firmware on the repo's Releases page (filter-v* tags); full user guide in FILTER.md. | ![GitHub last commit](https://img.shields.io/github/last-commit/jhuebert/MeshCore) |
...
| [openhop_core](https://github.com/openhop-dev/openhop_core) ![GitHub Repo stars](https://img.shields.io/github/stars/openhop-dev/openhop_core?style=social) | A Python MeshCore library with SPI LoRa radio support | |
...
| [uMap "MeshCore-de.fyi"](https://umap.openstreetmap.de/en/map/meshcore-defyi_130650) | Editable map of regions, mainly Germany. (Please also read [this context info](https://meshcore-de.fyi/meshcore:allgemeines:regions:reale-regions-in-repeatern).) For how to edit, see [here](https://meshcore-de.fyi/region_karte). |
...
| [MeshCore Regions Germany](https://meshcore-de.fyi/meshcore:allgemeines:regions:reale-regions-in-repeatern) | MeshCore regions in Germany below the federal state level. (For german basic regions, see [here](https://meshcore-de.fyi/meshcore:allgemeines:regions:basis).) |
| [KiekR Map](https://map.kiekr.app/) | Map as generated by uploads from users of [KiekR App](https://kiekr.app). |
| [Reticulum Network Planner](https://github.com/0xSeren/Reticulum-Network-Planner) | *(Applies to all LoRa!)* A tool that, given an amount of LoRa nodes and geographical area, calculates the optimal positions of those notes based on geographical data. |
| [meshcore-analyzer.eu](https://meshcore-analyzer.eu/) | MeshCore network analyzer. |
| [meshcore.observer](https://meshcore.observer) | Growing collection of MeshCore collectors/reporters/analyzers. |
| [meshcoretel.io](https://meshcoretel.io/) | Public MeshCore telemetry, visualization and statistics: live packet-propagation map, repeater-to-repeater link/propagation views, wardrive coverage map, region/country/mesh selection, node and observer directories, stats dashboards (packets, observers, MQTT/runtime, cohesion, noise, airtime, regions), channels view, and a prefix explorer. |
...
| Project | Description |
| --- | --- |
| [MeshBench](https://github.com/MeshBench/meshbench) | RF-accurate MeshCore simulation and development toolkit running real MeshCore firmware against a sample-accurate LoRa channel, real terrain, collisions, noise, and deterministic network conditions. Includes network planning and coverage analysis, firmware A/B testing, board emulation (including peripherals such as screens, buttons, touchscreens) , companion protocol simulation, application testing, CI fixtures, Wireshark/pcapng and SDR/IQ integration. [Website and docs](https://meshbench.github.io/)
...
- Belgium
  ...
  - [MeshPot](https://meshpot.be) — bilingual (FR/EN) guide for Brussels residents to join MeshCore and communicate off-grid, with a focus on privacy, surveillance resistance and practical self-protection
- Czech Republic
...
- Poland
  ...
  - [MeshCore Podlasie (Podlaskie Voivodeship)](https://meshcore.podlasie.pl/)
- Portugal
